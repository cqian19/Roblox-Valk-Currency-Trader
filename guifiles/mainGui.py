...
#
# Created: Tue Feb  9 23:14:47 2016
...
" } ")
        ...
        self.formLayoutWidget_3.setGeometry(QtCore.QRect(10, 10, 281, 184))
        ...
        self.formLayout_3.setWidget(1, QtGui.QFormLayout.FieldRole, self.tixEarlyCancel)
        ...
        self.formLayout_3.setWidget(2, QtGui.QFormLayout.FieldRole, self.tixTradeAll_2)
        self.tixSplitTrades_2 = QtGui.QCheckBox(self.formLayoutWidget_3)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Ignored)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tixSplitTrades_2.sizePolicy().hasHeightForWidth())
        self.tixSplitTrades_2.setSizePolicy(sizePolicy)
        self.tixSplitTrades_2.setText("")
        self.tixSplitTrades_2.setObjectName("tixSplitTrades_2")
        self.formLayout_3.setWidget(3, QtGui.QFormLayout.FieldRole, self.tixSplitTrades_2)
        self.formLayoutWidget_4 = QtGui.QWidget(self.groupBox_2)
        self.formLayoutWidget_4.setGeometry(QtCore.QRect(320, 10, 282, 161))
        ...
        self.robuxTradeAll_2 = QtGui.QCheckBox(self.formLayoutWidget_4)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Ignored)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.robuxTradeAll_2.sizePolicy().hasHeightForWidth())
        self.robuxTradeAll_2.setSizePolicy(sizePolicy)
        self.robuxTradeAll_2.setText("")
        self.robuxTradeAll_2.setObjectName("robuxTradeAll_2")
        self.formLayout_4.setWidget(2, QtGui.QFormLayout.FieldRole, self.robuxTradeAll_2)
